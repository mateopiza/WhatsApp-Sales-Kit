/**
 * Store PWA - Service Worker (Offline Shell & Asset Cache)
 * Version: store-v1.0.0
 */

const CACHE_STATIC_NAME = 'store-static-v1';
const CACHE_SHELL_NAME = 'store-shell-v1';
...
const PRECACHE_SHELL_ASSETS = [
  ...
  '/assets/hero/hero-placeholder.svg'
];
      ...
      caches.open(CACHE_STATIC_NAME).then(async (cache) => {
        ...
        try {
          ...
          if (request.destination === 'image') {
            return new Response(
              '<svg xmlns="http://www.w3.org/2000/svg" width="400" height="500" viewBox="0 0 400 500"><rect width="400" height="500" fill="#FAFAF9"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Poppins, sans-serif" fill="#8A8580" font-size="14">SIN CONEXIÓN</text></svg>',
