...
export const FavoritesDrawer: React.FC = () => {
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-label="Selección privada de joyas guardadas"
          ...
          {favoriteProducts.length === 0 ? (
            <div className="py-20 text-center max-w-xs mx-auto">
              ...
              <p className="text-xs text-taupe-contrast font-light mb-6 leading-relaxed">
                Guarda tus joyas preferidas tocando el icono de corazón en cada pieza para compararlas o solicitar una cotización conjunta.
              </p>
              <button
                onClick={() => {
            ...
            <div className="flex items-center justify-between">
              <div>
                <span className="text-[10px] uppercase tracking-wider text-taupe-contrast font-medium">
                  Total Estimado ({favoriteProducts.length} piezas)
                </span>
